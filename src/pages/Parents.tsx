...
import { Check, Star, Brain, Shield, Users, Heart, Download, FileText, ChevronLeft, Beaker } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-orange-50 to-white">
      ...
      <section id="top" className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-tight mb-6 font-heebo">
               {t('parents.hero.title')}
            </h1>
            <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed font-heebo">
               {t('parents.hero.subtitle')}
            </p>
            <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-500 mb-8 font-heebo">
      ...
      <section id="about" className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl md:text-4xl font-black text-center text-gray-800 mb-12 font-heebo">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {problems.map((item, index) => (
              <div key={index} className="bg-gray-50 rounded-2xl p-6 text-center border-2 border-gray-100 hover:border-orange-200 transition-colors">
                ...
                <p className="font-medium text-gray-700 font-heebo">{item.text}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-white to-amber-50/50">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black text-gray-800 mb-4 font-heebo">
            ...
            {benefits.map((benefit, index) => {
              ...
              return (
                <div key={index} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
                  ...
                  <h3 className="text-xl font-bold text-gray-800 mb-3 font-heebo">
                    {benefit.title}
                  </h3>
                  ...
                  <ul className="space-y-2">
                    {benefit.benefits.map((item, i) => (
                      <li key={i} className="flex items-center gap-2 text-sm text-gray-500 font-heebo">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-8 border-2 border-amber-200">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-4 font-heebo">
                  {t('parents.inside.detective.title')}
              </h3>
              <ul className="space-y-3">
                {(t('parents.inside.detective.list', { returnObjects: true }) as string[]).map((item, i) => (
                  <li key={i} className="flex items-center gap-2 text-gray-700 font-heebo">
          ...
          <div className="mt-12 text-center max-w-2xl mx-auto">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2 font-heebo">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {ageGroups.map((level, index) => (
              <div key={index} className={`rounded-2xl p-6 border-2 text-center ${level.color}`}>
                ...
                <span className="text-3xl font-black text-gray-800 block mb-1 font-heebo">{level.title}</span>
                <h3 className="font-bold text-gray-700 mb-4 font-heebo">{level.subtitle}</h3>
                <ul className="space-y-2 text-sm text-gray-600">
                  {level.features.map((feature, i) => (
                    <li key={i} className="flex items-center justify-center gap-2 font-heebo">
      ...
      <section id="reviews" className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl md:text-4xl font-black text-center text-gray-800 mb-4 font-heebo">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed font-heebo">
                  "{testimonial.text}"
                </p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-gray-800 font-heebo">{testimonial.name}</p>
      ...
      <section id="products" className="py-16 md:py-24 bg-gradient-to-b from-orange-600 to-amber-600 text-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-black mb-4 font-heebo">
               {t('parents.pricing.title')}
            </h2>
            <p className="text-lg text-orange-100 max-w-2xl mx-auto font-heebo">
          ...
          <div className="max-w-lg mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border-2 border-white/20 shadow-2xl">
              ...
              <div className="text-center mb-8">
                <p className="text-xl font-bold mb-1 font-heebo">{t('parents.pricing.product_name')}</p>
                <p className="text-orange-200 font-heebo">{t('parents.pricing.product_sub')}</p>
                <div className="mt-6">
                  <span className="text-5xl md:text-6xl font-black font-heebo">{t('parents.pricing.price')}</span>
                  <p className="text-sm text-orange-200 mt-2 font-heebo">
                     {t('parents.pricing.payment_type')}
                  </p>
                </div>
              </div>
              <div className="bg-white/10 rounded-xl p-4 mb-8">
                <p className="font-bold mb-3 text-center font-heebo">
                   {t('parents.pricing.what_you_get')}
                </p>
                <ul className="space-y-2">
                  {(t('parents.pricing.features', { returnObjects: true }) as string[]).map((feature, i) => (
                    <li key={i} className="flex items-center gap-2 text-sm font-heebo">
              ...
              <p className="text-center text-sm text-orange-200 mt-4 font-heebo">
                 {t('parents.pricing.secure')}
              </p>
            </div>
            <div className="mt-8 bg-white/10 rounded-2xl p-6 text-center border border-white/20">
              <span className="text-4xl block mb-3">🛡️</span>
              <h3 className="font-bold text-lg mb-2 font-heebo">
                 {t('parents.pricing.guarantee.title')}
              </h3>
              <p className="text-orange-100 text-sm font-heebo">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <details key={index} className="group bg-gray-50 rounded-xl border border-gray-200 overflow-hidden">
                <summary className="flex items-center justify-between cursor-pointer p-5 font-bold text-gray-800 hover:bg-gray-100 font-heebo">
                  {faq.q}
                  <ChevronLeft className={`w-5 h-5 text-gray-500 transition-transform group-open:-rotate-90 ${i18n.language === 'en' ? 'rotate-180' : ''}`} />
                </summary>
                <p className="px-5 pb-5 text-gray-600 leading-relaxed font-heebo">
                  {faq.a}
                </p>
              </details>
            ))}
      ...
      <section className="py-16 md:py-20 bg-gradient-to-b from-amber-100 to-orange-100">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8 font-heebo">
            ...
            <p className="text-sm text-gray-500 mt-6 font-heebo">
